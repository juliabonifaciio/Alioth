  ...
  return (
    <>
      ...
      <View style={[styles.container, { backgroundColor: currentColors.background }]}>
        ...
        <Text style={[styles.title, { color: currentColors.text }]}>Raquel</Text>
        ...
        <View style={styles.infoContainer}>
          <View style={styles.row}>
            ...
            <Text style={[styles.infoText, { color: currentColors.text }]}>
              <Text style={[styles.label, { color: currentColors.text }]}>Turma: </Text>
              <Text style={[styles.value, { color: currentColors.subtextTextInputAndSvg }]}>3° A</Text>
            </Text>
          </View>
          ...
          <View style={styles.row}>
            ...
            <View style={styles.flexRow}>
              ...
              <View style={styles.flexSpacer} />
              <Text style={[styles.infoText, { color: currentColors.text }]}>
                <Text style={[styles.label, { color: currentColors.text }]}>Saída: </Text>
                <Text style={[styles.value, { color: currentColors.subtextTextInputAndSvg }]}>2024</Text>
              </Text>
            </View>
          </View>
          ...
          <View style={styles.row}>
            ...
            <Text style={[styles.infoText, { color: currentColors.text }]}>
              <Text style={[styles.label, { color: currentColors.text }]}>Situação: </Text>
              <Text style={[styles.value, { color: currentColors.subtextTextInputAndSvg }]}>Cursando</Text>
            </Text>
          </View>
        </View>
